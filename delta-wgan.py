...
class wGAN():
    def __init__(self, max_filters, kernel_sz, n_chan, num_pix, lat_dim):
    ...
    def trainGAN(self, X_train, num_pix, num_files, iterations = NUM_ITER, batch_size = BATCH_SIZE):

        sample_interval_1     = SAMPLE_INT
        sample_interval_2   = sample_interval_1*10
    ...
    def saveGeneratedImages(self, it, examples=4):
        ...
        plt.tight_layout()
        plt.savefig('samples/samples_iter_%d.png' % it)
        plt.close()
...
if __name__ == '__main__':
    ...
    print('Initialize wGAN model with %d filters and latent dim %d.' %(max_filters, latent_dim))
    # Create class instance
    wgan        = wGAN(max_filters, kernel_sz, n_chan, num_pix, latent_dim)
